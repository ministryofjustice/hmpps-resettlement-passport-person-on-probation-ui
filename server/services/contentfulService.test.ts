...
import { fetchNavigation, fetchPageBySlug } from './contentfulService'
import { mockedPage, mockedPageResponse, mockedResponse } from '../testutils/mockedContentfulResponse'
...
describe('AppointmentService', () => {
  ...
  it('should fetch a page by slug', async () => {
    contentfulMock = {
      getEntries: jest.fn().mockResolvedValue(mockedPageResponse),
