...
const mapButton = (target: Target) => {
  ...
  return `<a href="${target?.fields?.link}" role="button" draggable="false" class="govuk-button govuk-button--start" data-module="govuk-button" data-qa="${target?.fields?.qatag}">
